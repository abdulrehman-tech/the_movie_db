            ...
            child: ListView(
              children: [
                ...
                ListTile(
                  onTap: () {
                    launch(
                        'mailto:rockxabdul101@gmail.com?subject=Feedback&body=Hello');
                  },
                  title: Text(
                    'Feedback',
                ...
                ListTile(
                  onTap: () {
                    launch(
                        'mailto:rockxabdul101@gmail.com?subject=Report%20Bug&body=');
                  },
                  title: Text(
                    'Report Bug',
                    style: normalText.copyWith(
                ...
                ListTile(
                  onTap: () {
                    launch('https://github.com/abdulrehman-tech/the_movie_db');
                  },
                  title: Text(
                    'Share my app',
                    style: normalText.copyWith(
